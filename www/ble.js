...
module.exports = {
	...
	startScanWithOptionsWithId: function(ids, options, success, failure) {
        var successWrapper = function(peripheral) {
            convertToNativeJS(peripheral);
            success(peripheral);
        };
        options = options || {};
        cordova.exec(successWrapper, failure, 'BLE', 'startScanWithOptionsWithIds', [ids, options]);
    },
...
module.exports.withPromises = {
	...
	startScanWithOptionsWithIds: module.exports.startScanWithOptionsWithIds,
